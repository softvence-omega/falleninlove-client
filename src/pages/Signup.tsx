        ...
        <div className="w-full max-w-md">
          ...
          <div className="space-y-6">
            ...
            <div>
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-4 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-teal-500 bg-gray-50 text-gray-500"
                />
              </div>
            </div>
            {/* Email Field */}
            ...
            <button
              ...
              className="w-full bg-teal-500 cursor-pointer text-white py-4 rounded-xl font-semibold text-lg hover:bg-teal-600 transition-colors focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2"
            >
              Register
            </button>
          </div>
