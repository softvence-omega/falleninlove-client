        ...
        <div className=" p-4">
            <div className=" rounded-xl shadow-md p-6 w-full border border-[#FFC399] ">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 mb-6">
                        ...
                        <div className="relative">
                            <select
                                ...
                                className="appearance-none bg-white border border-[#FF6A0066] rounded-lg px-4 py-2 pr-10 text-gray-700 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 min-w-[140px]"
                            >
                        ...
                        <div className="relative flex-1 max-w-md">
                            <Search className="absolute left-2 top-1/2 transform -translate-y-1/2 w-6 h-6 text-white bg-[#2CBCA4] p-1 rounded-full" />
                            <input
                                type="text"
                                placeholder="Search Users"
                                value={searchTerm}
                                onChange={(e) => setSearchTerm(e.target.value)}
                                className="w-full pl-10 pr-4 py-2 border border-[#FF6A0066] rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500"
                            />
                        </div>
                    </div>
                </div>
                ...
                <div className=" rounded-lg  overflow-hidden">
                    ...
                    {/* Progress Bar */}
                    <div className="mt-6 h-3 w-full bg-[#1A2E42] rounded-full overflow-hidden">
                        <div className="h-full bg-[#FF715B] w-[70%]"></div>
                        <div className="h-full bg-[#1A2E42] w-[30%]"></div>
                    </div>
                </div>
